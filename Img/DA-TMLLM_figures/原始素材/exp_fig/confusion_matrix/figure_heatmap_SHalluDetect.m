...
C(1, :) = [32, 1, 0, 0, 0, 3, 0, 0, 0, 0, 0]
C(2, :) = [0, 36, 0, 0, 0, 0, 0, 0, 0, 0, 0]
C(3, :) = [0, 0, 28, 0, 0, 5, 0, 1, 2, 0, 0]
C(4, :) = [0, 0, 0, 36, 0, 0, 0, 0, 0, 0, 0]
C(5, :) = [0, 0, 0, 0, 36, 0, 0, 0, 0, 0, 0]
C(6, :) = [0, 0, 1, 0, 0, 34, 0, 0, 1, 0, 0]
C(7, :) = [0, 0, 0, 0, 0, 0, 36, 0, 0, 0, 0]
C(8, :) = [1, 0, 1, 0, 0, 0, 0, 29, 3, 2, 0]
C(9, :) = [0, 0, 1, 0, 0, 2, 0, 1, 31, 1, 0]
C(10, :) = [0, 0, 0, 0, 0, 0, 0, 0, 0, 36, 0]
C(11, :) = [10, 0, 31, 0, 0, 3, 0, 0, 12, 4, 0]
