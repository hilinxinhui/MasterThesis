...
C(1, :) = [34, 0, 0, 1, 0, 0, 0, 0, 0, 1, 0]
C(2, :) = [2, 33, 0, 0, 1, 0, 0, 0, 0, 0, 0]
C(3, :) = [0, 0, 25, 0, 1, 4, 0, 2, 2, 2, 0]
C(4, :) = [0, 0, 0, 33, 0, 0, 1, 0, 1, 1, 0]
C(5, :) = [1, 11, 1, 3, 14, 3, 0, 0, 2, 1, 0]
C(6, :) = [0, 0, 1, 0, 0, 32, 0, 0, 3, 0, 0]
C(7, :) = [1, 0, 1, 0, 0, 0, 30, 4, 0, 0, 0]
C(8, :) = [0, 0, 0, 0, 1, 2, 0, 33, 0, 0, 0]
C(9, :) = [1, 1, 0, 0, 0, 1, 1, 0, 32, 0, 0]
C(10, :) = [1, 0, 0, 0, 0, 0, 0, 1, 0, 34, 0]
C(11, :) = [2, 5, 0, 0, 5, 0, 16, 0, 1, 1, 30]
