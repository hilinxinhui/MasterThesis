...
C(2, :) = [1, 35, 0, 0, 0, 0, 0, 0, 0, 0, 0]
C(3, :) = [0, 0, 25, 0, 0, 9, 0, 0, 2, 0, 0]
C(4, :) = [1, 0, 0, 35, 0, 0, 0, 0, 0, 0, 0]
C(5, :) = [15, 0, 0, 0, 12, 6, 3, 0, 0, 0, 0]
C(6, :) = [0, 0, 7, 0, 0, 29, 0, 0, 0, 0, 0]
C(7, :) = [0, 0, 0, 0, 0, 3, 32, 0, 1, 0, 0]
C(8, :) = [0, 0, 0, 0, 0, 0, 0, 35, 1, 0, 0]
C(9, :) = [0, 0, 2, 0, 0, 0, 0, 2, 32, 0, 0]
C(10, :) = [0, 0, 0, 0, 0, 0, 0, 1, 1, 34, 0]
C(11, :) = [16, 0, 16, 0, 0, 0, 0, 4, 16, 8, 0]
