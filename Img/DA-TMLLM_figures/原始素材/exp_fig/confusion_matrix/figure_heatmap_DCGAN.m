...
C(1, :) = [33, 0, 1, 0, 0, 2, 0, 0, 0, 0, 0]
C(2, :) = [4, 32, 0, 0, 0, 0, 0, 0, 0, 0, 0]
C(3, :) = [0, 0, 19, 0, 0, 17, 0, 0, 0, 0, 0]
C(4, :) = [0, 0, 0, 34, 0, 0, 0, 1, 0, 1, 0]
C(5, :) = [0, 0, 0, 0, 24, 12, 0, 0, 0, 0, 0]
C(6, :) = [0, 0, 1, 0, 0, 34, 0, 0, 1, 0, 0]
C(7, :) = [0, 0, 0, 0, 0, 1, 35, 0, 0, 0, 0]
C(8, :) = [0, 0, 0, 0, 0, 0, 0, 34, 1, 1, 0]
C(9, :) = [0, 0, 4, 0, 0, 2, 0, 0, 28, 2, 0]
C(10, :) = [0, 0, 0, 0, 0, 0, 0, 1, 0, 35, 0]
C(11, :) = [11, 0, 10, 0, 0, 0, 4, 0, 29, 6, 0]
