...
C(1, :) = [32, 0, 0, 1, 0, 0, 0, 0, 0, 1, 2]
C(2, :) = [3, 30, 0, 0, 1, 0, 0, 1, 0, 1, 0]
C(3, :) = [3, 0, 23, 1, 0, 3, 0, 2, 0, 0, 4]
C(4, :) = [0, 0, 0, 33, 0, 2, 0, 0, 0, 0, 1]
C(5, :) = [0, 0, 10, 1, 18, 3, 1, 1, 0, 1, 1]
C(6, :) = [0, 0, 0, 1, 0, 33, 0, 0, 0, 2, 0]
C(7, :) = [0, 0, 0, 0, 0, 0, 30, 1, 3, 0, 2]
C(8, :) = [0, 0, 0, 1, 0, 0, 0, 32, 0, 2, 1]
C(9, :) = [1, 0, 1, 1, 1, 0, 0, 0, 32, 0, 0]
C(10, :) = [0, 0, 0, 0, 0, 0, 0, 1, 2, 32, 1]
C(11, :) = [2, 6, 0, 0, 5, 0, 19, 0, 1, 2, 25]
