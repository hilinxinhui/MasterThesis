...
C(1, :) = [32, 0, 1, 0, 0, 1, 0, 0, 2, 0, 0]
C(2, :) = [5, 30, 0, 0, 0, 0, 0, 1, 0, 0, 0]
C(3, :) = [0, 0, 24, 0, 0, 10, 0, 1, 1, 0, 0]
C(4, :) = [1, 2, 0, 31, 0, 0, 1, 0, 0, 1, 0]
C(5, :) = [19, 0, 0, 0, 8, 5, 4, 0, 0, 0, 0]
C(6, :) = [0, 0, 2, 0, 0, 33, 0, 0, 1, 0, 0]
C(7, :) = [0, 0, 0, 0, 0, 6, 30, 0, 0, 0, 0]
C(8, :) = [1, 0, 0, 0, 0, 0, 0, 33, 1, 1, 0]
C(9, :) = [0, 0, 3, 0, 0, 2, 0, 1, 30, 0, 0]
C(10, :) = [0, 0, 0, 0, 0, 0, 0, 1, 2, 33, 0]
C(11, :) = [25, 0, 17, 0, 0, 0, 0, 0, 18, 0, 0]
