...
C(1, :) = [34, 0, 2, 0, 0, 0, 0, 0, 0, 0, 0]
C(2, :) = [2, 34, 0, 0, 0, 0, 0, 0, 0, 0, 0]
C(3, :) = [1, 0, 30, 0, 0, 4, 0, 0, 1, 0, 0]
C(4, :) = [0, 1, 1, 34, 0, 0, 0, 0, 0, 0, 0]
C(5, :) = [10, 0, 0, 0, 19, 4, 3, 0, 0, 0, 0]
C(6, :) = [0, 0, 1, 0, 0, 33, 0, 0, 2, 0, 0]
C(7, :) = [0, 0, 0, 0, 0, 2, 34, 0, 0, 0, 0]
C(8, :) = [2, 1, 0, 0, 0, 0, 0, 32, 0, 1, 0]
C(9, :) = [0, 0, 1, 0, 0, 2, 0, 0, 33, 0, 0]
C(10, :) = [0, 0, 0, 0, 0, 0, 0, 0, 1, 35, 0]
C(11, :) = [21, 0, 28, 0, 0, 5, 0, 0, 6, 0, 0]
