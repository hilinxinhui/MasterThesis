...
% 【P1】
在全球能源结构加速向清洁低碳转型的战略背景下，交通运输行业作为温室气体排放的主要来源之一，其电气化升级对实现“碳达峰、碳中和”目标具有重要支撑作用。电动汽车作为新能源交通工具的典型代表，正在经历技术迭代与市场扩张并行的产业化发展阶段。据 2025 年国际能源署（International Energy Agency, IEA）统计，2024 年全球电动汽车年销量逾 1700 万辆，市场渗透率突破 20\%，全球在役车辆存量接近 5800 万辆，电动汽车已在全球范围内形成高保有量的常态化应用格局。2025 年工信部在启动《“十五五”新型电池产业发展规划》编制工作时披露，“十四五”期间我国新能源汽车年均复合增长率约 46.15\%；随着 2024 年"两新"政策落地实施，我国动力电池技术提升和成本显著下降，电动汽车行业技术进步明显，我国已逐渐成为电动汽车强国。随着市场保有量的激增与预期服役周期的延长，产业界对电动汽车的关注点逐渐由新车状态下的基础续航能力拓展至其全生命周期内的安全性与运行可靠性\cite{geslin2025dynamic, nguyen2025closing}。电动汽车的电驱动架构依赖复杂的异构动力系统。在长期服役的要求下，动力系统存在渐进式性能退化与突发故障风险，探究动力系统可靠性演化规律并实现主动健康管理是保障电动汽车长期安全服役的基础\cite{zhao2025bridging, he2020electrical}。
...
% 【P3】
电动汽车的动力系统主要由储能子系统和传动子系统构成。基于IPHM技术体系，本文的研究对象聚焦于支撑整车动力输出的两大核心易损部件。第一类部件是作为整车能量中枢的动力电池，其在长期的充放电循环中发生不可逆的性能退化。第二类部件是作为动力传动中枢的旋转机械，其在持续的高转速与变载荷工况下易产生疲劳并引发结构性故障。在本文的研究设定中，针对动力电池的退化建模被解耦为两个侧重点不同的评估维度。一方面，是健康状态估计（State of Health, SOH）估计，即估计当前最大可用容量与额定容量之比，以评估电池当前循环性能；另一方面，是剩余使用寿命（Remaining Useful Life, RUL）预测，即预测从当前循环到寿命终止（End of Life, EOL）循环间的循环数，以评估电池未来性能演化趋势。针对旋转机械，本文开展故障诊断研究，即识别系统的异常状态及具体损伤类别。图\ref{fig:intro_ev_PHM}展示了本文所研究的电动汽车动力系统架构及其退化预测与故障诊断联合技术框架。
...
尽管如此，针对动力电池和旋转机械的~IPHM~方法在应用时都面临未知工况和分布差异带来的挑战。具体地，动力电池受电极材料、环境温度和充放电协议等多重耦合因素影响，其实际运行数据与循环老化数据反映的退化路径不尽相同。旋转机械受负载情况、转速变化和装配方式等复杂内外部条件影响，其故障特征的类别分布随工况变化，类别边界随工况漂移。基于此，本文所涉及的两类方法均需要克服已知数据和未知数据间的分布不一致性。
