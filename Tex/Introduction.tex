...
在“碳达峰、碳中和”战略牵引下，中国通过完善产业规划与监管、叠加需求
侧激励，并配套车辆购置税减免与充换电基础设施建设等措施，带动电动汽车加
速普及。仅在 2025 年第三季度，中国的纯电动汽车销量即超过 200 万辆[1]。与此
同时，电动汽车在全球范围内同样保持强劲增长。根据国际能源署（International
Energy Agency, IEA）发布的《2025 年全球电动汽车展望》报告，2024 年全球电
动汽车销量已超过 1700 万辆，约占全球汽车总销量的五分之一（超过 20%）[2]。
截至目前，欧盟、加拿大和英国均已立法，规定在 2035 年起停止销售新的内燃
机乘用车辆[3]。然而，渗透率的快速提升使得整车的长期可用性与全生命周期
成本面临巨大挑战，压力集中体现在关键系统上。作为承担能量存储、功率变
换与机械传动的核心总成，动力系统的预测与健康管理（Prognostics and Health
Management, PHM）因此成为电动汽车从“快速普及”迈向“高质量发展”阶段
的关键环节。

如图1.1所示，动力系统是电动汽车整车内部负责产生动力、控制动力、以
及驱动车辆的关键总成，具体组成包括：用于储能的动力电池、承担 AC/DC 变
换与调制的逆变器、完成机电能量转换的牵引电机，以及用于扭矩/转速匹配并
传递至车轮的减速器。在 PHM 视角下，行业共识逐渐由系统级问题聚焦至部件
级薄弱环节：其一，实证分析已将动力电池确定为整个动力系统中最不可靠的
部件[4]；其二，驱动电机轴承被广泛认为是电机失效的主因之一，文献报道超过40% 的电机故障可归因于轴承问题[5]。此外，电芯与轴承健康状态与整车安全与
可用性直接相关，局部退化可能经由复杂的电气、热与力学耦合链路放大为系统
级风险。真实道路工况下，载荷与温度波动频繁，健康指标呈现非平稳与分布迁
移特征，亟需先进 PHM 方法支撑可靠决策。据此，本文将围绕动力电池电芯与
电机轴承的 PHM 展开深入研究。
在此框架下，故障诊断与退化预测作为电机轴承与动力电池电芯全生命周
期管理的可操作化核心环节，将 PHM 落实为可监测、可预警与可维护的具体实
践。故障诊断旨在判定系统是否处于正常运行状态，识别故障类型及其相应程
度。退化预测则对性能退化动力学进行建模，估计部件时点和长期健康状态。然
而，传统的诊断与预测方法依赖专家进行人工观察与诊断，通过合理布设传感器
并采用恰当算法分析结果。此类方法不仅增加了人工投入，而且传统方法的效果
在很大程度上取决于专家经验。
随着车载传感器、控制器局域网（Controller Area Network, CAN）以及自动
化技术的广泛配备与应用，大量传感器被部署于机电设备上以采集多源数据（如
振动、温度、图像等），为智能化方法的潜在实施奠定了坚实的基础[6,7]。伴随人
工智能算法的进步，智能故障诊断与退化预测日益兴起[8–10]，并已在学术界与工
业界取得广泛成功。智能故障诊断与退化预测的主要优势在于：（1）基于多源高
维数据的深层自动特征学习与端到端建模，能有效捕捉复杂非线性故障模式，提
升诊断与退化预测精度与鲁棒性，进而减少对人工与专家经验的依赖；（2）支持
全天候在线状态感知与长期退化预测，促进提前且最优的维护决策，缩短非计划
停机时间、降低人工与备件成本，提升系统可靠性与安全性。
鉴于电机轴承与动力电池电芯在失效机理与演化时间尺度上存在本质差异，
且两者面临的安全合规约束各异。忽视这种场景特异性，将导致研究难以满足电
动汽车对安全与可靠性的严苛需求。因此，本论文采取分场景研究路线，以应对
不同失效模式下的工程风险。对于轴承，其作为传动系统的核心，微小的局部损
伤若未被及时识别，极易迅速演变为结构性破坏。面对车载运行环境下强噪声耦
合与变转速的振动信号，现有离线模型常因无法适应未知故障与跨域工况而失
效。因此本论文在轴承场景侧重智能故障诊断，重点关注对已知与未知故障的可
靠识别以及单工况跨域泛化能力，以支撑运行过程中的高效预警与处置。对于电
芯，其容量衰退与内阻增长隐蔽性强，且在长周期充放电中伴随严重的安全边界
漂移。若缺乏精准的退化预测，维护策略将难以有效实施，直接增加热失控等事
故风险。针对加速老化与真实工况偏差大的问题，本论文在电芯场景侧重退化预
测，重点关注非平稳条件下的时点退化预测与三重漂移条件下的长期退化预测，
为维护决策与寿命管理提供量化依据。
